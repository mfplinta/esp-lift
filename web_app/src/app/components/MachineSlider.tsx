...
export default function MachineSlider({ isLeftSlider }: MachineSliderProps) {
  ...
  // Track reps changes for flash animation key
  const flashKey = reps !== prevRepsRef.current && reps !== undefined && reps > 0
    ? reps
    : null;
  ...
  return (
    <div className="relative h-full">
      ...
      >
        ...
        {/* 2. Animation Flash */}
        {flashKey !== null && (
          <div key={flashKey} className="absolute w-full h-full rounded-3xl pointer-events-none bg-white z-21 animate-[fadeOut_0.4s_ease-out] top-0" />
        )}
